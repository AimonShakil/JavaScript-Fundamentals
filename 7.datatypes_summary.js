...
we call them/ copy them original data is not being given there refernce is not shared bu they are being copied and shared 
...
Declaring Symbols whe using frontend library like react 
if even same Values will be passed we will not get same result*/

const id = Symbol('123');
const anotherId = Symbol ('123') // These two looks same but have differnt values nad gives values as false on Comparison
...
//random()
// intrensigly when making games we need range like for dice 1-6
